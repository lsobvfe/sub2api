export default {
    accounts: {
      ...
      openai: {
        ...
        rawRelay: 'Raw relay (API Key only)',
        rawRelayDesc:
          'Preserves the Codex method, query, body, User-Agent, and end-to-end request headers while replacing only the upstream target and API key. Disable it to restore managed forwarding immediately.',
