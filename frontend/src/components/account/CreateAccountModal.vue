    ...
    >
      ...
      >
        <div class="flex items-center justify-between gap-4">
          ...
          <button
            type="button"
            data-testid="create-openai-raw-relay-toggle"
...
const isOpenAIModelRestrictionDisabled = computed(() =>
  form.platform === 'openai' && (openaiPassthroughEnabled.value || openaiRawRelayEnabled.value)
)
...
const buildOpenAIExtra = (base?: Record<string, unknown>): Record<string, unknown> | undefined => {
  ...
  if (accountCategory.value === 'apikey' && openaiRawRelayEnabled.value) {
    extra.openai_raw_relay = true
  } else {
    delete extra.openai_raw_relay
  }
