...
const isOpenAIModelRestrictionDisabled = computed(() =>
  props.account?.platform === 'openai' && (openaiPassthroughEnabled.value || openaiRawRelayEnabled.value)
)
...
const applyOpenAIModelMappingCredentials = (credentials: Record<string, unknown>) => {
  const shouldApplyModelMapping = !openaiPassthroughEnabled.value && !openaiRawRelayEnabled.value
...
const handleSubmit = async () => {
  ...
  try {
    ...
    if (props.account.type === 'apikey') {
      ...
      const shouldApplyModelMapping = !(props.account.platform === 'openai' && (openaiPassthroughEnabled.value || openaiRawRelayEnabled.value))
    ...
    if (props.account.platform === 'openai' && (props.account.type === 'oauth' || props.account.type === 'setup-token' || props.account.type === 'apikey')) {
      ...
      if (props.account.type === 'apikey' && openaiRawRelayEnabled.value) {
