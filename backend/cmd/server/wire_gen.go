...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	openAIStreamHoldStore := repository.NewOpenAIStreamHoldStore(redisClient)
	openAIStreamHoldTracker := service.NewOpenAIStreamHoldTracker(openAIStreamHoldStore, settingService, configConfig)
	opsHandler := admin.NewOpsHandler(opsService, openAIStreamHoldTracker)
	...
	openAIGatewayHandler := handler.ProvideOpenAIGatewayHandler(openAIGatewayService, concurrencyService, billingCacheService, apiKeyService, usageRecordWorkerPool, errorPassthroughService, contentModerationService, opsService, openAIStreamHoldTracker, grokQuotaService, configConfig, coordinator)
