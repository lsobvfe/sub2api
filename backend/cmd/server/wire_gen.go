...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	streamHoldHook := service.ProvideStreamHoldHook()
	apiKeyService := service.ProvideAPIKeyService(apiKeyRepository, userRepository, groupRepository, userSubscriptionRepository, userGroupRateRepository, apiKeyCache, configConfig, billingCacheService, concurrencyService, streamHoldHook)
