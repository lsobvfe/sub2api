...
func (_u *APIKeyUpdate) SetStreamHoldEnabled(v bool) *APIKeyUpdate {
	_u.mutation.SetStreamHoldEnabled(v)
	return _u
}

// SetNillableStreamHoldEnabled sets the "stream_hold_enabled" field if the given value is not nil.
func (_u *APIKeyUpdate) SetNillableStreamHoldEnabled(v *bool) *APIKeyUpdate {
	if v != nil {
		_u.SetStreamHoldEnabled(*v)
	}
	return _u
}
...
func (_u *APIKeyUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	if value, ok := _u.mutation.StreamHoldEnabled(); ok {
...
// SetStreamHoldEnabled sets the "stream_hold_enabled" field.
func (_u *APIKeyUpdateOne) SetStreamHoldEnabled(v bool) *APIKeyUpdateOne {
	_u.mutation.SetStreamHoldEnabled(v)
	return _u
}

// SetNillableStreamHoldEnabled sets the "stream_hold_enabled" field if the given value is not nil.
func (_u *APIKeyUpdateOne) SetNillableStreamHoldEnabled(v *bool) *APIKeyUpdateOne {
	if v != nil {
		_u.SetStreamHoldEnabled(*v)
	}
	return _u
