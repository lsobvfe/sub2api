...
// SetStreamHoldEnabled sets the "stream_hold_enabled" field.
func (_c *APIKeyCreate) SetStreamHoldEnabled(v bool) *APIKeyCreate {
	_c.mutation.SetStreamHoldEnabled(v)
	return _c
}

// SetNillableStreamHoldEnabled sets the "stream_hold_enabled" field if the given value is not nil.
func (_c *APIKeyCreate) SetNillableStreamHoldEnabled(v *bool) *APIKeyCreate {
	if v != nil {
		_c.SetStreamHoldEnabled(*v)
	}
	return _c
}
...
func (_c *APIKeyCreate) defaults() error {
	...
	if _, ok := _c.mutation.StreamHoldEnabled(); !ok {
		v := apikey.DefaultStreamHoldEnabled
		_c.mutation.SetStreamHoldEnabled(v)
	}
...
func (_c *APIKeyCreate) check() error {
	...
	if _, ok := _c.mutation.StreamHoldEnabled(); !ok {
		return &ValidationError{Name: "stream_hold_enabled", err: errors.New(`ent: missing required field "APIKey.stream_hold_enabled"`)}
	}
	if _, ok := _c.mutation.Quota(); !ok {
...
func (_c *APIKeyCreate) createSpec() (*APIKey, *sqlgraph.CreateSpec) {
	...
	if value, ok := _c.mutation.StreamHoldEnabled(); ok {
		_spec.SetField(apikey.FieldStreamHoldEnabled, field.TypeBool, value)
		_node.StreamHoldEnabled = value
	}
...
// SetStreamHoldEnabled sets the "stream_hold_enabled" field.
func (u *APIKeyUpsert) SetStreamHoldEnabled(v bool) *APIKeyUpsert {
	u.Set(apikey.FieldStreamHoldEnabled, v)
	return u
}

// UpdateStreamHoldEnabled sets the "stream_hold_enabled" field to the value that was provided on create.
func (u *APIKeyUpsert) UpdateStreamHoldEnabled() *APIKeyUpsert {
	u.SetExcluded(apikey.FieldStreamHoldEnabled)
	return u
}
...
// SetStreamHoldEnabled sets the "stream_hold_enabled" field.
func (u *APIKeyUpsertOne) SetStreamHoldEnabled(v bool) *APIKeyUpsertOne {
	return u.Update(func(s *APIKeyUpsert) {
		s.SetStreamHoldEnabled(v)
	})
}

// UpdateStreamHoldEnabled sets the "stream_hold_enabled" field to the value that was provided on create.
func (u *APIKeyUpsertOne) UpdateStreamHoldEnabled() *APIKeyUpsertOne {
	return u.Update(func(s *APIKeyUpsert) {
		s.UpdateStreamHoldEnabled()
	})
}
...
// SetStreamHoldEnabled sets the "stream_hold_enabled" field.
func (u *APIKeyUpsertBulk) SetStreamHoldEnabled(v bool) *APIKeyUpsertBulk {
	return u.Update(func(s *APIKeyUpsert) {
		s.SetStreamHoldEnabled(v)
	})
}
...
// UpdateStreamHoldEnabled sets the "stream_hold_enabled" field to the value that was provided on create.
func (u *APIKeyUpsertBulk) UpdateStreamHoldEnabled() *APIKeyUpsertBulk {
	return u.Update(func(s *APIKeyUpsert) {
		s.UpdateStreamHoldEnabled()
	})
}
