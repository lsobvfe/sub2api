...
func init() {
	...
	// apikeyDescStreamHoldEnabled is the schema descriptor for stream_hold_enabled field.
	apikeyDescStreamHoldEnabled := apikeyFields[5].Descriptor()
	// apikey.DefaultStreamHoldEnabled holds the default value on creation for the stream_hold_enabled field.
	apikey.DefaultStreamHoldEnabled = apikeyDescStreamHoldEnabled.Default.(bool)
